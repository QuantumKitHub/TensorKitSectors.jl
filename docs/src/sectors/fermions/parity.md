...
`fusiontensor` is defined for array construction, but it emits a warning because plain arrays with `FermionParity` labels cannot preserve all fermionic signs.
